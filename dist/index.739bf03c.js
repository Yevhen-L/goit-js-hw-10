...
window.addEventListener("DOMContentLoaded", async ()=>{
    try {
        ...
        const breeds = await (0, _catApi.fetchBreeds)();
...
breedSelect.addEventListener("change", async (event)=>{
    ...
    if (breedId) try {
        loader.style.display = "block";
        catInfo.innerHTML = "";
        const catData = await (0, _catApi.fetchCatByBreed)(breedId);
    ...
    else catInfo.style.display = "block";
});

},{"./cat-api":"5IWAT","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","notiflix":"5z0Oc","slim-select":"lzHUr"}],"5IWAT":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
(0, _axiosDefault.default).defaults.headers.common["x-api-key"] = "live_2CGZdPyFWcyHvOItdvM9hAsQf4KTxUvS8BDacuYCmOzQvpYIiY01veSSfi66u8XR";
const fetchBreeds = async ()=>{
    try {
        const response = await (0, _axiosDefault.default).get("https://api.thecatapi.com/v1/breeds");
...
const fetchCatByBreed = async (breedId)=>{
    try {
        const response = await (0, _axiosDefault.default).get(`https://api.thecatapi.com/v1/images/search?breed_ids=${breedId}`);
